...
export default function Agenda({ isActive }) {
  ...
  const salvarEventosBackend = async (novosEventos) => {
    ...
    try {
      ...
      toast.success(
        editando !== null ? "Evento atualizado!" : "Evento criado!"
      );
    } catch (error) {
        ...
        <div className="p-6">
          ...
          {eventos.length === 0 ? (
            ...
            >
              ...
              <p className="text-gray-400 mb-4">Nenhum evento agendado ainda</p>
                    ...
                    return (
                      <motion.div
                        ...
                        className={`glass-card p-4 hover:bg-white/15 transition-all duration-200 ${
                          ...
                          isPassado(evento.data, evento.hora) &&
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <span
                                className={`px-2 py-1 text-xs rounded-full bg-${statusColor}-500/20 text-${statusColor}-400 capitalize`}
                              >
                                {evento.status}
                              </span>
                              {isHoje(evento.data) && (
                          ...
                          <div className="flex gap-1 ml-4">
                            {evento.status === "pendente" && (
                              <Button
                                ...
                                icon={CheckCircle}
                                onClick={() =>
                                  alterarStatus(index, "confirmado")
                                }
